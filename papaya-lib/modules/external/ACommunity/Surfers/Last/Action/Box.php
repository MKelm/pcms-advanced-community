<?php
/**
 * Advanced community surfers last action box
 *
 ...
 * @subpackage External-ACommunity
 */
class ACommunitySurfersLastActionBox extends ACommunitySurfersBox {

  /**
   * Parameter prefix name
   * @var string $paramName
   */
  public $paramName = 'acslab';

  /**
   * Display mode
   * @var string
   */
  protected $_displayMode = 'lastaction';

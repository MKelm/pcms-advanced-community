 ...
 * Basic box class
 */
require_once(dirname(__FILE__).'/../../Surfers/Box.php');
 ...
 * @subpackage External-ACommunity
 */
class ACommunitySurferContactsBox extends ACommunitySurfersBox {

  /**
   * Parameter prefix name
   * @var string $paramName
   */
  public $paramName = 'acscb';

  /**
   * Display mode
   * @var string
   */
  protected $_displayMode = 'contacts';

<?php
/**
 * Advanced community ui content groups
 *
 ...
 * @subpackage External-ACommunity
 */
class ACommunityUiContentGroups extends ACommunityUiControlCollectionPaging {
  ...
  * @var string
  */
  protected $_itemClass = 'ACommunityUiContentGroup';
  ...
  * @var string
  */
  protected $_tagName = 'groups';

  /**
   * Parameter name to change page
   * @var string
   */
  public $pagingParameterName = 'groups_page';
}